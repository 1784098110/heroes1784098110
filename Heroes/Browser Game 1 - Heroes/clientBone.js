...
(function () {
	function Player(x, y) {
        ...
        this.speed = 300;
        this.speedDiag = Math.sqrt(Math.pow(this.speed, 2) / 2);
	...
	Player.prototype.draw = function (context, xView, yView) {
        const angle = Math.atan2(Game.controls.mouseY - (this.y - yView), Game.controls.mouseX - (this.x - xView));
        ...
        context.fill();
        context.closePath();
        //context.fillRect((0 - this.radius) - xView, (0 - this.radius) - yView, this.width, this.height);
        context.restore();
        
        //console.timeEnd('drawPlayer');
	}
...
window.addEventListener("keyup", function (e) {
	switch (e.keyCode) {
		...
		case 83: // down arrow
			...
			break;
		case 27: // key Esc pauses the game
			Game.togglePause();
			break;
	}
}, false);
